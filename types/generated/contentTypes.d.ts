...
export interface ApiBanners1Banners1 extends Struct.CollectionTypeSchema {
  collectionName: 'banners2';
  info: {
    displayName: 'Banners';
    pluralName: 'banners2';
    singularName: 'banners1';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCustomProductTypeCustomProductType
  extends Struct.CollectionTypeSchema {
  collectionName: 'custom_product_types';
  info: {
    displayName: 'Custom Product Type';
    pluralName: 'custom-product-types';
    singularName: 'custom-product-type';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::custom-product-type.custom-product-type'
    > &
      Schema.Attribute.Private;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    authCode: Schema.Attribute.String;
    bankResponseRaw: Schema.Attribute.JSON;
    ...
    contractAccepted: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    contractAcceptedAt: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    grandTotal: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    hostlogkey: Schema.Attribute.String;
    ...
    orderNumber: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    posnetXid: Schema.Attribute.String & Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    ...
    >;
    vatTotal: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    ykbRefNo: Schema.Attribute.String;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::banners1.banners1': ApiBanners1Banners1;
      'api::blog-post.blog-post': ApiBlogPostBlogPost;
      'api::category-product.category-product': ApiCategoryProductCategoryProduct;
      'api::category.category': ApiCategoryCategory;
      'api::custom-product-type.custom-product-type': ApiCustomProductTypeCustomProductType;
